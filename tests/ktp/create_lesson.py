...
LESSON_TOPIC_BY_KTP = {
    ...
    "Квадратные уравнения":      "Дискриминант арқылы квадрат теңдеуді шешу",
    "Функции и графики":         "Функцияның графигін салу",
    "Производная":               "Туынды және оның геометриялық мағынасы",
    "Геометрические построения": "Циркуль мен сызғыш арқылы геометриялық салулар",
    "Логарифмы":                 "Логарифм және оның қасиеттері",
    # ── Физика ───────────────────────────────────────────────────────────────
    "Гравитация":                "Бүкіләлемдік тартылыс заңы",
    "Законы Ньютона":            "Ньютонның бірінші заңы",
    "Механическое движение":     "Бірқалыпты түзусызықты қозғалыс",
    "Давление и сила":           "Қысым және күш ұғымдары",
    "Электрический ток":         "Электр тізбегі және оның элементтері",
    "Оптика":                    "Жарық және оның таралуы",
    "Тепловые явления":          "Жылу алмасу және оның түрлері",
}
# ---------------------------------------------------------------------------
